...
echo machineName,starttime,endtime,buildtime:$machineName,$PullStartTime,$PullEndTime,$pulltime >> /mnt/azurefiles/$today/Scenario1-25/acr-buid-output-time.log
